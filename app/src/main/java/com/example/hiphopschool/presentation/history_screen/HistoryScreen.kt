...
import com.example.hiphopschool.presentation.history_screen.components.GenericScreen
import com.example.hiphopschool.presentation.history_screen.components.GenericSubHeading
        ...
        Card(
            ...
            LazyColumn(state = listState) {
                item(1) {
                    ...
                    GenericSubHeading(text = "2014–present: Trap and mumble rap era")

                    GenericScreen(
                        headLineText = "Mumble Rap and Trap",
                        bodyText = mumbleRapText
                    )

                    GenericScreen(
                        headLineText = "Age of streaming",
                        bodyText = ageOfStreamingText
                    )
                }
            }
        }
